...
async def fm(ctx: commands.Context, text: str, ascending: Optional[bool] = None) -> None:
...
async def peak(ctx: commands.Context, text: str, ascending: Optional[bool] = None) -> None:
    data = await get_players_by_fc_string(text)
